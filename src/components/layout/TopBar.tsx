...
export function TopBar() {
  ...
  const hasConnectionIssues =
    disconnectedTelegram.length > 0 || disconnectedBrokers.length > 0;
    ...
    switch (type) {
      ...
      default:
        return (
          <Info
            size={14}
            className={theme === "dark" ? "text-dark-muted" : "text-gray-400"}
          />
        );
    }
  };
  ...
  const connectionIssuesCount =
    disconnectedTelegram.length + disconnectedBrokers.length;
                ...
                >
                  <div className="flex items-center gap-1.5 mb-1.5">
                    ...
                    <span className="text-[10px] font-semibold uppercase tracking-wide text-warning">
                      {connectionIssuesCount} Issue
                      {connectionIssuesCount > 1 ? "s" : ""}
                    </span>
                  </div>
              ...
              {displayNotifications.length === 0 && !hasConnectionIssues ? (
                <div className="py-6 text-center">
                  <Bell
                    ...
                    className={
                      theme === "dark"
                        ? "mx-auto mb-1.5 text-dark-muted"
                        : "mx-auto mb-1.5 text-gray-300"
                    }
                  />
                  <p
                    className={clsx(
